...
global using static KelThuzad.KelThuzadMain;
...
namespace KelThuzad{
    public class KelThuzadMain:BloonsTD6Mod{
        ...
        public class FactoryFindAndSetupPrototypeAsync_Patch{
            ...
            public static bool Prefix(Factory __instance,string objectId,Il2CppSystem.Action<UnityDisplayNode>onComplete){
                ...
                if(TowerBundles.ContainsKey(bundle)){
                    ...
                    udn.name=objectId;
                    if(File.Exists(MelonHandler.ModsDirectory+"\\kelthuzadhirestextures.bundle")){
                        if(HiResTextures==null||HiResTextures[0]==null){
                            HiResTextures.Clear();
                            AssetBundle HiResBundle=AssetBundle.LoadFromFile(MelonHandler.ModsDirectory+"\\kelthuzadhirestextures.bundle");
        ...
        private static MelonLogger.Instance mllog=new MelonLogger.Instance("KelThuzad");
        ...
        public class AudioFactoryStart_Patch{
            ...
            public static void Postfix(ref AudioFactory __instance){
                ...
                foreach(Type type in MelonHandler.Mods.First(a=>a.Info.Name=="KelThuzad").Assembly.GetTypes()){
